...
var slotT = "defense" # Type identifier for this slot (e.g., "craft", "inventory", "equipment")

func _ready() -> void:
	var style:StyleBoxFlat = StyleBoxFlat.new()
	style.bg_color = Color(0.1, 0.6, 0.2, 0.6) # Back to base teal
...
func _on_mouse_entered() -> void:
	is_mouse_in = true
	var style:StyleBoxFlat = StyleBoxFlat.new()
	style.bg_color = Color(0.3, 0.6, 0.4, 1) # Back to base teal
	add_theme_stylebox_override ("panel", style)
