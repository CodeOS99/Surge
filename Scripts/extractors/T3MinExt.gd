...
var spawnable_resources = [preload("res://Scenes/Pickupables/coal.tscn"), preload("res://Scenes/Pickupables/iron.tscn"), preload("res://Scenes/Pickupables/gold.tscn"), preload("res://Scenes/Pickupables/diamond.tscn")]
@export var coal_data: InvItemData
@export var iron_data: InvItemData
@export var gold_data: InvItemData
@export var diamond_data: InvItemData

var _custom_timer_duration: float = 10.0 
...
func _on_custom_timer_timeout() -> void:
	if placed:
		...
		elif _res.name == "diamond":
			_res.init(diamond_data.duplicate())
